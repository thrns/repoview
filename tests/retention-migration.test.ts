...
describe('retention cleanup integration', () => {
  ...
  it('covers each required category and keeps share dependencies safe', () => {
    for (const table of ['view_events', 'repository_events', 'file_engagement', 'viewer_sessions', 'viewers', 'share_access_attempts', 'notification_deliveries', 'shares', 'workspaces']) {
